        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MusicBrainzId = table.Column<string>(type: "character(36)", fixedLength: true, maxLength: 36, nullable: false),
                    Name = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    Disambiguation = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverArtUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    ReleaseDate = table.Column<DateOnly>(type: "date", nullable: true),
                    ReleaseDatePrecision = table.Column<int>(type: "integer", nullable: false),
                    PrimaryType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    CachedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteArtists", x => new { x.UserId, x.ArtistId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Reviews_Score_Range", "\"Score\" >= 0 AND \"Score\" <= 100");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ReviewId_CreatedAt",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_TargetType_TargetId_IsLike",
                table: "Likes",
                columns: new[] { "TargetType", "TargetId", "IsLike" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_AlbumId_CreatedAt",
                table: "Reviews",
                columns: new[] { "AlbumId", "CreatedAt" },
